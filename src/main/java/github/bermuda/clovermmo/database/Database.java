...
public abstract class Database {
    ...
    public void setRace(Player player, String race, Integer total) {
        ...
        try {
            conn = getSQLConnection();
            ps = conn.prepareStatement("INSERT INTO " + table + " (player,race,total) VALUES (?,?,?)"); // IMPORTANT. In SQLite class, We made 3 colums. player, Kills, Total.
            ...
            ps.setString(2, race); // This sets the value in the database. The colums go in order. Player is ID 1, kills is ID 2, Total would be 3 and so on. you can use
