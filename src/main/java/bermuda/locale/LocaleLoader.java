...
public final class LocaleLoader {
    private static final String BUNDLE_ROOT = "bermuda.languages.locale";
        ...
        try {
            ...
            try {
                ...
                if (!key.contains("Guides")) {
                    MainCloverMMO.getPlugin().getLogger().warning("Could not find locale string: " + key);
                }
    ...
    private static void initialize() {
        if (bundle == null) {
            ...
            Locale locale = null;
            String[] myLocale = DefaultConfig.getInstance().getLocale().split("[-_ ]");
